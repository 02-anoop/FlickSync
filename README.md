...
A comprehensive suite for Movie Review Sentiment Analysis (**FlickSync**, built with Django 5) and Movie Recommendations (**FlickSync**, built with Flask).
...
### 2. Running FlickSync (Django Review Analysis)
...
### 3. Running FlickSync (Flask Recommendations)
...
```
FlickSync/
├── Flicksync-main/        # Django FlickSync Application
│   └── Flicksync/
│       ├── manage.py
│       ├── review/        # Sentiment Analysis app & models
│       └── db.sqlite3
├── app.py                 # Flask FlickSync Recommendation Server
