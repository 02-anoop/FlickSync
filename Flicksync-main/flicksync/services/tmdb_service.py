...
def get_poster_path(movie_id):
    ...
    try:
        url = f"https://api.tmdb.org/3/movie/{m_id}?api_key={TMDB_API_KEY}&language=en-US"
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 450" width="300" height="450">
  ...
  <text x="150" y="231" text-anchor="middle" font-family="Outfit, sans-serif" font-size="11" font-weight="700" fill="#b45309" letter-spacing="2">FLICKSYNC</text>
